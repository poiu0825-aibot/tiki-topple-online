...
function GameRoom({G,ctx,player,room,name,isMyTurn:turnOwned,client,messages,chatRef,chatText,setChatText,sendChat,quickSend,currentID,rulesOpen,setRulesOpen,link,leaveRoom}) {
  ...
  useEffect(()=>{ if(!G||!me||!client)return; if(G.phase==='lobby'||(G.phase==='roundEnd'&&me.joined)) client.moves.SetProfile({name, color:me.preferredColor}); },[name,me?.preferredColor,me?.joined,G?.phase]);
