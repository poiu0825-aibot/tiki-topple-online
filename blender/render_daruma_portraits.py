...
render_scene.render.filepath = str(OUTPUT / "daruma-head-00.png")
...
try:
    for index, root in enumerate(roots):
        ...
        render_scene.render.filepath = str(OUTPUT / f"daruma-head-{index:02d}.png")
    ...
    print("Daruma portraits:", [str(OUTPUT / f"daruma-head-{i:02d}.png") for i in range(9)])
